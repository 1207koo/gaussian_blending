...
class GaussianModel:
    ...
    def _compute_3D_filter_coef(self):
        """Compute the coefficient for 3D filter applied to opacity."""
        scales = self.get_scaling
    ...
    def compute_3D_filter(self, cameras):
        ...
        # Pre-convert all camera R/T to GPU tensors once (avoids repeated CPU->GPU transfers)
    ...
    def construct_list_of_attributes(self, exclude_filter: bool = False) -> List[str]:
        l = ["x", "y", "z", "nx", "ny", "nz", "red", "green", "blue"] # color for visualization
    ...
    def densify_and_split(
        ...
        grads_abs_threshold: torch.Tensor,
        scene_extent: float,
        N: int = 2,
        dense: bool = False,
    ) -> None:
